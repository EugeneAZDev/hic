...
class PasswordResetEmailJobDto extends createZodDto(PasswordResetEmailJobSchema) {}
...
export class QueueController {
  ...
  @ApiQuery({ name: 'queueName', required: false, description: 'Filter by queue name' })
  ...
  @ApiResponse({ status: 200, description: 'Completed email jobs cleared successfully' })
  ...
  @ApiResponse({ status: 200, description: 'Failed email jobs cleared successfully' })
  ...
  @ApiResponse({ status: 200, description: 'User sync queue cleared successfully' })
  ...
  @ApiResponse({ status: 200, description: 'Completed user sync jobs cleared successfully' })
  ...
  @ApiResponse({ status: 200, description: 'Failed user sync jobs cleared successfully' })
  ...
  @ApiResponse({ status: 200, description: 'User sync queue paused successfully' })
  ...
  @ApiResponse({ status: 200, description: 'User sync queue resumed successfully' })
