...
import { UpdateUserSchema, SyncUserSchema } from "@hic/shared-schemas";
import { UpdateUser, UserFromSchema } from "@hic/shared-dto";
...
export class UsersController {
  ...
  async create(
    @ZodBody(SyncUserSchema) createUserDto: any,
