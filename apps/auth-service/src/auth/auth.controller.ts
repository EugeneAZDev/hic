...
export class AuthController {
  ...
  @ApiResponse({ status: 200, description: 'Login successful', schema: { $ref: '#/components/schemas/AuthResponseSchema' } })
  ...
  @ApiResponse({ status: 201, description: 'Registration successful', schema: { $ref: '#/components/schemas/AuthResponseSchema' } })
  ...
  async register(
    ...
    console.log('AuthController: Register endpoint called with:', { ...registerDto, password: '[HIDDEN]' });
  ...
  async forgotPassword(
    @Body(new ZodValidationPipe(ForgotPasswordSchema)) forgotPasswordDto: ForgotPassword
  ...
  @ApiResponse({ status: 200, description: 'Token refreshed', schema: { $ref: '#/components/schemas/TokenResponseSchema' } })
